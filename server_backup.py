...
def main() -> None:
    ...
    model.add(tf.keras.layers.Dense((20), activation='relu',input_shape=(57,)))
    ...
    strategy = fl.server.strategy.FedAvg(min_available_clients=number_of_clients,min_fit_clients=number_of_clients,fraction_eval=0,min_eval_clients=30,eval_fn=get_eval_fn(model),initial_parameters=model.get_weights(),)
